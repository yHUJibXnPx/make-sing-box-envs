...
![Watchers](https://img.shields.io/github/watchers/yHUJibXnPx/make-sing-box-envs) ![Stars](https://img.shields.io/github/stars/yHUJibXnPx/make-sing-box-envs) ![Forks](https://img.shields.io/github/forks/yHUJibXnPx/make-sing-box-envs) ![Vistors](https://visitor-badge.laobi.icu/badge?page_id=yHUJibXnPx.make-sing-box-envs) ![LICENSE](https://img.shields.io/badge/license-MIT-green.svg)
<!-- <a href="https://star-history.com/#yHUJibXnPx/make-sing-box-envs&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=yHUJibXnPx/make-sing-box-envs&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=yHUJibXnPx/make-sing-box-envs&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=yHUJibXnPx/make-sing-box-envs&type=Date" />
  </picture>
</a> -->
...
## 目录结构
    ...
    ├── 1.15.0-alpha.7.json                         # sing-box json 模板  
    ├── LICENSE                                     # TIM 协议  
...
1. 打开终端下载脚本，例如：
   ...
   ```bash
   cd $HOME/Desktop
   curl -L -C - --retry 3 --retry-delay 5 --progress-bar -o 'make-sing-box-env.sh' 'https://github.com/yHUJibXnPx/make-sing-box-envs/raw/refs/heads/master/make-sing-box-env.sh'
   ```
...
4. 安装完成后，将生成配置文件与可执行二进制：
   ...
   $HOME/Desktop/sing-boxs
    ...
    │   ├── ui
    │   └── ui.zip
    ├── sing-box-1.15.0-alpha.7-darwin-arm64.tar.gz
    ├── sing-box-start.sh
    ├── subs-fix.py
    └── temp_config.json
   ```
...
## 联系与反馈
遇到问题或有改进建议，请在 [issues](https://github.com/yHUJibXnPx/make-sing-box-envs/issues) 中提出，或直接联系项目维护者。
