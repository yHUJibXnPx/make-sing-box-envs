...
SING_BOX_PATH='/SagerNet/sing-box/releases/download/v1.15.0-alpha.3'
...
SING_BOX_CONFIG_TEMPLATES_URL="https://github.com/yHUJibXnPx/make-sing-box-envs/raw/refs/heads/master/1.15.0-alpha.3.json"
SING_BOX_CONFIG_TEMPLATES_FILE=${SING_BOX_DIR_PATH}'/1.15.0-alpha.3.json'
